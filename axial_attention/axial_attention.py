...
def calculate_permutations(num_dimensions, emb_dim): # 2 ，-1
...
class AxialAttention(nn.Module):
    def __init__(self, dim, num_dimensions = 2, heads = 8, dim_heads = None, dim_index = -1, sum_axial_out = True):
        ...
        self.dim_index = dim_index if dim_index > 0 else (dim_index + self.total_dimensions) #3

        attentions = []
        for permutation in calculate_permutations(num_dimensions, dim_index): # [[(0,2),1,3],[(0,1),2,3]]
